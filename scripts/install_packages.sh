...
if [ "$PLATFORM" = "osx" ]; then
  ...
  if exists brew; then
    ...
    brew install bat coreutils ctags direnv git-delta gnu-sed git gh go nodenv openssl pyenv readline ripgrep source-highlight tig tmux tree vim watch yarn zsh
