...
nnoremap <silent> [unite]g :<C-u>Unite -no-split file_rec/git<CR>
nnoremap <silent> [unite]a :<C-u>Unite -no-split file_rec/async<CR>
nnoremap <silent> [unite]y :<C-u>Unite -no-split -buffer-name=register register<CR>
